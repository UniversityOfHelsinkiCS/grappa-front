...
const findValidationRule = (fieldname, modelname) =>
  validationRules[modelname].find(field => {
 ...
 */
export const validateField = (name, value, modelname) => {
 ...
 */
export const validateModel = (values, modelname) => {
