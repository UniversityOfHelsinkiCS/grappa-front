...
export class ThesisEmails extends Component {
    ...
    renderNotification(name, type, reminder, isDone) {
        return (
            <div className="field">
                <div className="ui right input">
                    <h3 className="ui header">{name}</h3>
    ...
    render() {
        ...
        return (
            <div>
                ...
                {this.renderNotification("Student Notification", "StudentRegistrationNotification", thesisProgress.StudentRegistrationNotification || {}, thesisProgress.studentNotificationSent || thesisProgress.StudentRegistrationNotification != null)}
                {this.renderNotification("Supervising Professor Notification", "SupervisingProfessorNotification", thesisProgress.SupervisingProfessorNotification || {}, thesisProgress.SupervisingProfessorNotification != null)}
            </div>
        );
    }
}
