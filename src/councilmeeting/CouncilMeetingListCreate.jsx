      ...
      <div className="field">
        ...
        <div className="three fields">
          ...
          <div className="field">
            ...
            <input
              type="text"
              value={newCouncilMeeting.values.instructorDeadlineDays}
          ...
          <div className="field">
            ...
            <input
              type="text"
              value={newCouncilMeeting.values.studentDeadlineDays}
    ...
    return (
      <div className="ui form">
        <div className="ui two fields">
          <div className="field">
            { this.renderCreate(newCouncilMeeting) }
            { this.renderEdit(updateCouncilMeeting) }
          </div>
          <div className="field">
            <h2 className="ui dividing header">Upcoming councilmeetings</h2>
            <p>
